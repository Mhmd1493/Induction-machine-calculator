Write a computer program to draw the developed torque and input current verses the motor speed (or the motor slip) in case of starting a three-phase squirrel cage induction motor in cases of:
